...
namespace Travel_Accommodation_Booking_Platform_F.CustomMessages;

public static class CustomMessages
{
    public const string UnSetSecretKey = "SECRET_KEY environment variable is not set.";
    public const string UnSetConnectionString = "TRAVEL_ACCOMMODATION_CONNECTION_STRING environment variable is not set.";
